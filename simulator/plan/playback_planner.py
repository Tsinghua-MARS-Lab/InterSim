...
class PlaybackPlanner(EnvPlanner):
    """
    ...
    def plan_ego(self, current_state, current_frame_idx):
        ...
        #     ending_pt = [my_current_pose[0] - np.sin(change_axis(current_yaw)) * 1000, my_current_pose[1] - np.cos(change_axis(current_yaw)) * 1000]
        #     my_interpolator = SudoInterpolator(np.array([my_current_pose[:2], ending_pt]), my_current_pose)
        #
