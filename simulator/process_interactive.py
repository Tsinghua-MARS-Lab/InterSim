...
starting_file = 0
ending_file = starting_file + 100
if ending_file == 1000:
    ending_file = '1k'
saving_file_path = f'interactive_relations_traingInter_allAgents_{starting_file}_{ending_file}.pickle'
...
print("saving to ", saving_file_path)
...
data_loader = WaymoDL(filepath=tf_example_dir, file_to_start=starting_file, max_file_number=100)
...
# counter = 0
# data_to_save = {}
# all_files = [f for f in os.listdir(".") if os.path.isfile(f) and 'pickle' in f and 'traingset' in f]
# for dic_file_name in all_files:
#     data = load_data_from_pickle(dic_file_name)
#     for i in data.keys():
#         counter += 1
