...
def add_argument(parser):
    ...
    parser.add_argument("--max_influencer",
                        default=128,
                        type=int)
    parser.add_argument("--zero_label_loss",
                        default=1.0,
                        type=float)
    # agent_selection:
    # PA-reactor: to predict, influencer: all valid
    # AA-reactor: all valid, influencer: all valid
    parser.add_argument("--agent_selection",
                        default='PA',
                        type=str)

    parser.add_argument("--starting_file_num",
                        default=None,
                        type=int)
    parser.add_argument("--ending_file_num",
                        default=None,
                        type=int)
    parser.add_argument("--frame_offset",
                        default=None,
                        type=int)
